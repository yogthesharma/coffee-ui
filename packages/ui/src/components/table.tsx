...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border transition-colors duration-150 ease-out hover:bg-muted/50 data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-3 py-2.5 align-middle text-card-foreground [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
